  ...
  <div class="h-screen ">
       <div class="content ml-20 mr-20">
           <div class="head-content mt-5 mb-10">
               <div class="head tittle text-4xl text-fontColor-primary font-semibold">
                Solicitud de tareas
               </div>
               <div class="spacer bg-fontColor-primary w-full h-0.5 mt-5"></div>
           </div>
           <div class="body-content mt-10">
               <div class="body-content-head flex flex-col justify-center items-center">
                   <div class="body-department-name text-3xl text-fontColor-primary font-semibold">
               ...
               <div class="body-content-general">
                   <div class="body-subject my-10">
                        <div class=" text-2xl text-fontColor-primary">Asunto:</div> 
                        <input name="Asunto" v-model="title" class=" rounded-full w-full h-10 outline-none pl-2 border-2 border-fontColor-primary">
                        <small>Descripción breve de la solicitud</small>
                   </div>
                   <div class="body-email my-10">
                        <div class=" text-2xl text-fontColor-primary">Correo electrónico: </div> 
                        <input name="Asunto" v-model="email" class=" rounded-full w-full h-10 outline-none pl-2 border-2 border-fontColor-primary">
                        <small>Correo electrónico para los avisos automáticos sobre esta tarea.</small>
                   </div>
                   <div class="body-message">
                       <div class=" text-2xl text-fontColor-primary">Mensaje: </div> 
                        <textarea name="Asunto" v-model="message" class=" rounded-3xl w-full h-32 outline-none pt-2 pl-3 border-2 border-fontColor-primary"></textarea>
                        <small>Descripción detallada de la solicitud</small>
                   </div>
                   <div clasS="body-adjunto my-10">
                        <div class=" text-2xl text-fontColor-primary">Adjunto: </div>
                        <div @click="fakeClick" class="border flex flex-row rounded-full w-full h-10 align-middle">
                            ...
                            <button  class="border float-right rounded-r-full bg-gray-300 text-fontColor-primary w-20 h-10">
                                Examinar
               ...
               <button class="bg-buttonColor-primary text-black rounded-lg p-4 float-right" @click="createIncident">ENVIAR</button>
           </div>
       </div>
    </div>
</template>
