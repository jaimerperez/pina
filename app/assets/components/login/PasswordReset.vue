  ...
  <div class="w-full h-full flex flex-col justify-center items-center  text-Barlow">
    ...
    <div class="w-full h-full flex flex-col font-Barlow text-fontColor-primary">
        <div class="flex flex-col justify-center items-center py-2">
            <label for="email" class="w-2/6 mx-3 lg:text-xl">Introduce su email y le enviaremos un código para resetear la contraseña  </label>
            <input type="email" placeholder="Introduzca su correo electrónico" id="email" name="email" v-model="email" class="w-2/6 lg:w-4/12 lg:h-full bg-gray-200 border border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent rounded-lg" >
        </div>
