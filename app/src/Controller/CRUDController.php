...
class CRUDController
{
    protected $connectionParams = array(
        'url' => 'mysql://root:root@10.10.244.230:3306/database?serverVersion=10.5.8-mariadb', //https://www.doctrine-project.org/projects/doctrine-dbal/en/latest/reference/configuration.html#connecting-using-a-url
    );
    ...
    function add($data)
	{
        ...
        if ($this->useTimestamps && ! empty($this->deletedAtField) && ! array_key_exists($this->deletedAtField, $data))
            $data[$this->deletedAtField] = '0000-00-00 00:00:00';

        if ($this->useSoftDeletes === true)
            $data[$this->deletedField] = 0;
